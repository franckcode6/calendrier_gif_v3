	...
	<main>
		...
		<form class="mb-3" action="" method="post">
			<label class="form-label" for="email">Email</label> <input
				...
				required> <label class="form-label" for="mot_de_passe">Mot
				de passe</label> <input class="form-control" type="password"
				name="MOT_DE_PASSE" placeHolder="Mot de Passe" required> <input
				class="button-green" type="submit" value="Connexion"> <a
				href="inscription" class="button-red"> S'inscrire </a>
		</form>
